...
$empstsmt = $db->prepare('SELECT * FROM utilisateurs');
$empstsmt->execute();
$candidats = $empstsmt->fetchAll();
...
<tr>
      ...
      <td> <a href="<?php echo $candidat["diplome"]; ?>"> <button type="button" class="btn btn-success"> Télécharger </button> </a> </td>      
</tr>
