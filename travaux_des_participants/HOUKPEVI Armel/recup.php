...
{
	$db = new PDO(
        'mysql:host=localhost;dbname=cours_db;charset=utf8',
        'root',
        ''
    );
}
...
<form>
        ...
        <div class="card">
                ...
                <a href="tmp/<?php echo basename($_FILES["cv"]["name"]);?>"target="_blank"> <b>Télecharger votre CV</b></a>

               <br> <a href="tmp/<?php echo basename($_FILES["diplome"]["name"]);?>"target="_blank"> <b>Télecharger votre diplome</b></a> </br>
        </div>
        </div>
