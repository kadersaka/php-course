  ...
  <body>
     <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            <li><a class="dropdown-item" href="listecandidats.php">liste des Candidats</a></li>
...
if (! in_array($extensiondiplome, $alloweddiplomeExtensions)){
 ...
 move_uploaded_file($_FILES['cv']['tmp_name'],'cvs/' . strip_tags(basename($_FILES['cv']['name'])));
 move_uploaded_file($_FILES['diplome']['tmp_name'],'diplomes/' . strip_tags(basename($_FILES['diplome']['name'])));
 ...
 $motivation=strip_tags($_POST["lm"]);
 $cv= 'cvs/' . strip_tags(basename($_FILES['cv']['name']));
 $diplome= 'diplomes/' . strip_tags(basename($_FILES['diplome']['name']));
