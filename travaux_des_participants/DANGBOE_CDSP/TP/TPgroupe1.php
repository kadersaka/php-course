...
<html lang="fr">
  ...
  <div class="container-fluid">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="listecandidats.php">Administration<a>
        </li>
      </ul>
      <form class="d-flex">
    ...
    <div class="container">
      ...
      <div class="row">
        <h3>Remplissez le formulaire ci-dessous pour postuler au poste d'expert IT</h3>
      </div>
