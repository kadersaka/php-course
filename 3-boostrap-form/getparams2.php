<?php
/**
 * Transmettre les données directement d'ans l'URL
 * Récupérer les odnnées passées
 * les traitées, 
 * les affichées
 ...
 * 
 */
if (!isset($_GET['email']) || !isset($_GET['message']) || !isset($_GET['objet']) )
{
...
<html lang="en">
  ...
  <body>
  <h1>Message envoyé, nous vous repondrons dans les plus bref délais!</h1>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="card-text"><b>Objet</b> : <?php echo $_GET['objet']; ?></p>
